...
| `/api/v1/projects/{project}/repositories/{repositoryId}/archive`, `/api/v1/projects/{project}/repositories/{repositoryId}` | Project-admin archival and safe removal of an empty logical repository record; neither operation deletes OCI content |
