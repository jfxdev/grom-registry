...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        RepositoryProfile: "unknown" | "container_image" | "opentofu_module" | "helm_chart" | "wasm" | "sbom" | "generic_oci" | "mixed";
        /** @enum {string} */
        ArtifactKind: "container_image" | "image_index" | "opentofu_module" | "helm_chart" | "wasm" | "sbom_spdx" | "sbom_cyclonedx" | "signature" | "generic_oci" | "unknown_oci";
        /** @enum {string} */
...
export const repositoryProfileValues: ReadonlyArray<FlattenedDeepRequired<components>["schemas"]["RepositoryProfile"]> = ["unknown", "container_image", "opentofu_module", "helm_chart", "wasm", "sbom", "generic_oci", "mixed"];
export const artifactKindValues: ReadonlyArray<FlattenedDeepRequired<components>["schemas"]["ArtifactKind"]> = ["container_image", "image_index", "opentofu_module", "helm_chart", "wasm", "sbom_spdx", "sbom_cyclonedx", "signature", "generic_oci", "unknown_oci"];
