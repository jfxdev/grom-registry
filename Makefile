.PHONY: generate test test-coverage test-registry-e2e test-admin-e2e test-backup-restore-e2e build dev compose-up compose-up-postgres compose-down reset-local backup backup-inspect restore
